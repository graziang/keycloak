...
public class SessionTimeouts {
    ...
    public static long getAuthSessionLifespanMS(RealmModel realm, ClientModel client, RootAuthenticationSessionEntity key) {
        return SessionExpiration.getAuthSessionLifespan(realm) * 1000L;
    }
}
